...
class GraphicDisplay:
    def __init__(self, screensize, board, font, line_width=3, margin=10):  # add colour parameters
    ...
    def display_cell(self, r, c): #line width = 3, margin = 10
        # throw type error
        if self.board.get_cell_state(r, c) == 'X':
        ...
        elif self.board.get_cell_state(r, c) == 'O':
